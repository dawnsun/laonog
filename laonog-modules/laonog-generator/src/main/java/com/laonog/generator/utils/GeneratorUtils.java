    ...
    public static void generatorCode(Map<String, String> table,
        ...
        for (String template : templates) {
            ...
            try {
                ...
                //String targetFile = getFileName(template, tableEntity.getClassName(),tableEntity.getClassname().toLowerCase(), config.getString("package"), config.getString("mainModule"));
                //String targetPath = "D:/"+targetFile.replace(".", "\\");
